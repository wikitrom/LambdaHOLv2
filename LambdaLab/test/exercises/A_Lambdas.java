...
public class A_Lambdas {
	...
	public void a_predicate4() {
		...
		// exercise ->
		// Predicate<String> startsWithJAndLengthIs7 = s -> (s.startsWith("J") &&
		// s.length() == 7);
	...
	public void b_function4() {
		...
		// alternatively
		Function<String, Integer> lengthBis2 = length.compose(unNullify);

		assertEquals((Integer) 14, lengthBis2.apply("Hello JavaOne!"));
		assertEquals((Integer) 0, lengthBis2.apply(""));
		assertEquals((Integer) 0, lengthBis2.apply(null));
	...
	public void c_consumer4() {
		...
		// exercise ->
		Consumer<List<String>> consumer = l -> c1.andThen(c2).accept(l);
		// <-
	...
	public void e_bifunction1() {
		// exercise ->
		// alternative 1
		BiFunction<String, String, String> bifunc = (first, second) -> String.format("%s%s%s", first, second, first);
		// alternative 2
		BiFunction<String, String, String> bifunc2 = (first, second) -> first + second + first;
		// <-

		assertEquals("FirstSecondFirst", bifunc.apply("First", "Second"));
		// alternative 2
		assertEquals("FirstSecondFirst", bifunc2.apply("First", "Second"));
	}
